      ...
      <div className="homepage_container_content">
         <div>
            <div className="homepage_content_body">
               <div className="homepage_content_body_header">
                  <nav>
                     <a className="homepage_content_body_header_first">
                        <div className={foryou ? 'foryou_active' : 'foryou_passive'}>
                           For you
                           {foryou && <div></div>}
                        </div>
                     </a>
